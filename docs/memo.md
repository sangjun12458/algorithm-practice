...
### 17387. 선분 교차 2
- CCW - 벡터 외적을 사용하여 방향을 확인
- 서로 같은 직선에 있는 경우, 교차하는 지 확인

---

### 13975. 파일 합치기 3
- 우선순위 큐로 푸는 greedy 문제
- 인접한 두 파일이 아닌 임의의 두 파일을 합칠 수 있다.
- 따라서 항상 가장 작은 두 파일을 먼저 합치는 방식이 최적 - Huffman Coding
- (인접한 두 파일이어야 하는 경우: 구간 DP + Knuth 최적화)
